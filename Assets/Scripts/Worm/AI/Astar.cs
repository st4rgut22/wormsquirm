...
public class Astar : MonoBehaviour
{
    ...
    public delegate void astarPath(List<Vector3Int> gridCellPathList, Vector3 nullCell);
    ...
    public class Item
    {
        ...
        public Item(int fromStartCost, Vector3Int cell, Vector3Int goalLocation)
        {
            ...
            this.toEndCost = calculateManhattanDist(cell, goalLocation);
            calculateTotalCost();
        }
    ...
    private void Awake()
    {
        ...
        nullCell = mapOffset + new Vector3Int(1, 1, 1);
    }
    ...
    void findShortestPath(Dictionary<Vector3Int, GameObject> obstacleDict, List<Item> unknownPathList, HashSet<Item> unknownPathSet)
    {
        while (unknownPathList.Count > 0)
        {
            ...
            if (item.cell.Equals(goalLocation))
            {
                ...
                astarPathEvent(shortestPath, nullCell);
                return;
            }
