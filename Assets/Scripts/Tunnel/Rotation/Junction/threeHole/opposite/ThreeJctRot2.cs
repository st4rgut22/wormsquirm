...
namespace Rotation
{
    public class ThreeJctRot2 : Rotation
    {
        Dictionary<List<Direction>, Quaternion> upDirListDict = new Dictionary<List<Direction>, Quaternion>(new DirectionList())
        {
            ...
            { new List<Direction>(){ Direction.Forward, Direction.Up }, Quaternion.Euler(0, 180, 0) },
        ...
        {
            { new List<Direction>(){ Direction.Back, Direction.Down }, Quaternion.Euler(0, 0, 180) },
            { new List<Direction>(){ Direction.Down, Direction.Left }, Quaternion.Euler(0, 90, 180) },
            { new List<Direction>(){ Direction.Down, Direction.Forward }, Quaternion.Euler(0, 180, 180) },
            { new List<Direction>(){ Direction.Down, Direction.Right }, Quaternion.Euler(0, 270, 180) }
        };

        Dictionary<List<Direction>, Quaternion> leftDirListDict = new Dictionary<List<Direction>, Quaternion>(new DirectionList())
        {
            { new List<Direction>(){ Direction.Back, Direction.Left }, Quaternion.Euler(0, 0, 90) },
            { new List<Direction>(){ Direction.Forward, Direction.Left }, Quaternion.Euler(0, 180, 270) },
            { new List<Direction>(){ Direction.Left, Direction.Up }, Quaternion.Euler(90, 270, 0) },
            { new List<Direction>(){ Direction.Down, Direction.Left }, Quaternion.Euler(270, 90, 0) }
        };

        Dictionary<List<Direction>, Quaternion> rightDirListDict = new Dictionary<List<Direction>, Quaternion>(new DirectionList())
        {
            { new List<Direction>(){ Direction.Back, Direction.Right }, Quaternion.Euler(0, 0, 270) },
